...
import br.gov.lexml.madoc.server.catalog.store.policy.PolicyDecision;
...
public final class LocalCacheDocumentStore implements DocumentStore {
	...
	private InputStream getFromCacheFirst(String docUri) throws Exception {
	...
	private InputStream getFromStoreFirst(String docUri) throws Exception {
		File f = getFileForUri(docUri);
