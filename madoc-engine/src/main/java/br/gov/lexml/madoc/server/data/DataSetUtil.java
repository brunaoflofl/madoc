package br.gov.lexml.madoc.server.data;
...
import br.gov.lexml.madoc.server.schema.entity.DataSetType;
import br.gov.lexml.madoc.server.schema.entity.DataSetValueType;
import br.gov.lexml.madoc.server.schema.entity.DataSetsType;
