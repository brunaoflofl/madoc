...
import br.gov.lexml.madoc.server.schema.entity.AutoriaQuestionType;
import br.gov.lexml.madoc.server.schema.entity.BaseOptionType;
import br.gov.lexml.madoc.server.schema.entity.CheckBoxGroupQuestionType;
import br.gov.lexml.madoc.server.schema.entity.ChoiceListQuestionType;
import br.gov.lexml.madoc.server.schema.entity.ComboQuestionType;
import br.gov.lexml.madoc.server.schema.entity.CustomQuestionType;
import br.gov.lexml.madoc.server.schema.entity.MadocDocumentType;
import br.gov.lexml.madoc.server.schema.entity.RadioBoxGroupQuestionType;
...
import br.gov.lexml.madoc.server.schema.entity.BaseOptionInterface;
import br.gov.lexml.madoc.server.schema.entity.OptionableQuestionInterface;
import br.gov.lexml.madoc.server.util.ReflectionUtil;
...
public class OptionsExpansion {
	...
	public MadocDocumentType cloneAndExpandOptions(
		...
		finalMadocDocument.accept(new BaseVisitor() {
			...
			@Override
			public VisitorAction enter(AutoriaQuestionType aBean) {
				return processOptions(aBean);
			}

			@Override
			public VisitorAction enter(CustomQuestionType aBean) {
				return processOptions(aBean);
			}
