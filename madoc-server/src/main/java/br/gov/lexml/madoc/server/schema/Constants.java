package br.gov.lexml.madoc.server.schema;
...
import br.gov.lexml.madoc.server.schema.entity.MadocDocumentsCatalogItemType;
import br.gov.lexml.madoc.server.schema.entity.MadocLibrariesCatalogItemType;
import br.gov.lexml.madoc.server.schema.entity.MadocLibraryType;
import br.gov.lexml.madoc.server.schema.entity.MadocSkeletonsCatalogItemType;
import br.gov.lexml.madoc.server.schema.entity.ResourcesCatalogItemType;
...
public final class Constants {
	...
	public final static String DEFAULT_URI = "http://www.lexml.gov.br/madoc/2.0";
	...
	public static final long PREFERENCES_DEFAULT_MAX_AGE_MILLIS = 10000L; // 10m
